...
function disableEarse() {
    const controls = document.getElementById("earseimg");
    console.log(controls);
    controls.src = "./assets/earse.png";

    isEarse = false
}

function enableEarse() {
    const controls = document.getElementById("earseimg");
    console.log(controls)
    controls.src = "./assets/earseEnable.png";
    isEarse = true
}

function enableDisableEarse() {
    if (isEarse) {
        console.log(isEarse)
        disableEarse();
    } else {
